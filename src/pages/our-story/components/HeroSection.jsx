  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        <div className="mb-12">
          <h2 className="text-white text-2xl sm:text-3xl font-headline mb-8" style={{opacity: 0, height: 0, overflow: 'hidden'}}>{text?.countdown}</h2>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 max-w-4xl mx-auto">
            ...
            <div
              ...
              className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                ...
                <div className="text-4xl sm:text-5xl font-bold text-white mb-2 font-headline">
                  {String(item?.value)?.padStart(2, '0')}
                </div>
                <div className="text-white/80 text-sm sm:text-base uppercase tracking-wider">
                  {item?.label}
                </div>
              </div>
            )}
