...
const OurStory = () => {
  ...
  const timelineEvents = {
    ...
    },
    {
      ...
      imageAlt: "Couple dressed elegantly, woman in burgundy dress and man in black shirt with white pants at outdoor event",
    ...
    },
    {
      ...
      fullDescription: "We each bought our first apartment, and incredibly, they're side by side. We're a couple and neighbors at the same time! We do live at the same flat, but this allow us to rent one of the apartments, creating a source of income for our future together.",
      icon: "Users",
    ...
    },
    {
      ...
      fullDescription: "The proposal was an adventure across South America. It started in Santiago, continued through Rio de Janeiro, and culminated in Medellín, Colombia. Each city held special meaning for us, and the journey itself represented our relationship - full of surprises, spanning borders, and always moving forward together.",
      icon: "Heart",
    ...
    },
    {
      ...
      icon: "GemRing",
      image: "/assets/images/hero-wedding.png",
      imageAlt: "Happy couple smiling together, woman in burgundy dress and man in black shirt at evening celebration",
      location: "Santiago, Chile",
    ...
    },
    {
      ...
      icon: "Home",
      image: "./assets/images/ia8sq4ia8sq4ia8s.png",
      imageAlt: "Interior acogedor de apartamento con decoración moderna y cálida iluminación",
      location: "Barrio Yungay, Santiago",
    ...
    },
    {
      ...
      icon: "Plane",
      image: "./assets/images/hero-wedding.png",
      imageAlt: "Pareja vestida elegantemente, mujer con vestido burdeo y hombre con camisa negra y pantalón blanco en evento al aire libre",
      location: "Cancún, México",
    ...
    },
    {
      ...
      fullDescription: "Cada uno compró su primer departamento, e increíblemente, están uno al lado del otro. ¡Somos pareja y vecinos al mismo tiempo! De todas formas vivimos juntos en el mismo departamento, esto nos permite arrendar uno de ellos, creando una fuente de ingresos para nuestro futuro juntos.",
      icon: "Users",
      image: "./assets/images/1163c-img_2436-835x540.jpg",
      imageAlt: "Edificio de departamentos modernos en Santiago con arquitectura contemporánea",
      location: "Santiago, Chile",
    ...
    },
    {
      ...
      fullDescription: "La propuesta fue una aventura a través de Sudamérica. Comenzó en Santiago, continuó por Río de Janeiro, y culminó en Medellín, Colombia. Cada ciudad tenía un significado especial para nosotros, y el viaje en sí representaba nuestra relación - llena de sorpresas, cruzando fronteras, y siempre avanzando juntos.",
      icon: "Heart",
      image: "./assets/images/25zrdw25zrdw25zr.png",
      imageAlt: "Momento romántico de propuesta de matrimonio con pareja emocionada y feliz",
      location: "Santiago (Chile), Rio de Janeiro (Brasil) and Medellín (Colombia)",
    ...
    },
    {
      ...
      icon: "GemRing",
      image: "./assets/images/0C5BD249-7678-426A-814F-9BB6E6F9F5E6_1_105_c.jpeg",
      imageAlt: "Pareja feliz sonriendo juntos, mujer con vestido burdeo y hombre con camisa negra en celebración nocturna",
      location: "Santiago, Chile",
  ...
  return (
    <>
      <Helmet>
        <title>Our Story - Fabi & Feli | A Journey of Love</title>
